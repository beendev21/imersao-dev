🧠 Base de Conhecimento de Inteligências Artificiais
Projeto criado durante a Imersão 10 - Alura e Google – 2025.
...
Desenvovido um sitema  de Busca dentro da base de coheciento e também um menu separando as IAS por categorias.
...
HTML / CSS / JavaScript: Para a interface do usuário (Front-end) e a lógica de exibição/filtragem dos dados.
...
Node para gerar arquivo JSON/Dados Oficiais: A fonte dos dados catalogados, garantindo precisão nas informações.
